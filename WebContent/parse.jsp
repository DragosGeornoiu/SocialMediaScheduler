...
<body>
	...
	<form ACTION="ParseWebsite">
		Please select a parser: <br> <input type="text" name="website"
			size="20px"> <br> <INPUT TYPE="hidden" NAME="radioss"
			VALUE="http://persdev-q.com/"> <INPUT TYPE="radio"
			NAME="radios" VALUE="http://www.brainyquote.com/" checked="checked">
